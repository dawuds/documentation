...
- BNM RMiT (28 Nov 2025) is structured the same way — it issues principle-level requirements (e.g., Section 11.13 on the Cyber Incident Response Plan; Section 10.54 on access control principles) and supporting detail (e.g., the nine mandatory CRF elements at Section 11.3, the cybersecurity control measures at Section 11.5 implementing Appendix 5). M3 lets you trace each RMiT requirement into your own documents in a way an inspector can follow. See [`regulatory-mapping-reference.md`](regulatory-mapping-reference.md) for the canonical mapping.
