...
For Malaysian licensed banks, BNM RMiT (28 Nov 2025) Section 8.1 requires the **Board** to approve the technology risk appetite, Section 8.2 establishes Board oversight responsibilities for technology and cyber risk, and Section 8.3 requires a Board-level technology committee. The master Information Security Policy in this repo is positioned as a board-approved document accordingly. The Technology Risk Management Framework itself is established under Section 9 (with designated CISO requirements at Section 9.4–9.5).
