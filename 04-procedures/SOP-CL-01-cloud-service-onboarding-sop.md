...
| 7 | Head of Cloud | Provision landing zone aligned to CIS Foundations + bank overlay per [STD-CL-01 Section 3.1](../03-standards/STD-CL-01-cloud-security-standard.md) | Landing zone operational |
| 8 | Head of Cloud | Configure identity federation per [STD-CL-01 Section 3.2](../03-standards/STD-CL-01-cloud-security-standard.md) | Federation operational |
| 9 | CISO + Head of Cloud | Enable CSPM coverage; baseline detection rules | CSPM operational |
| 10 | Head of Cloud + CISO | Document exit plan per [POL-20 Section 4.7](../02-policies/POL-20-cloud-acceptable-use-policy.md); record in [REG-CL](../06-registers/REG-CL-cloud-service-register.md) and [REG-CEX](../06-registers/REG-CEX-cloud-exit-plan-register.md) | Exit plan recorded |
| 11 | Head of Cloud | Update [REG-CL](../06-registers/REG-CL-cloud-service-register.md) entry to Active | Active entry |

## 4. Exception handling
Material RMiT Appendix 10 departure: RMC approval required per [POL-20 Section 4.8](../02-policies/POL-20-cloud-acceptable-use-policy.md); justified in REG-CL `appendix_10_departures`.

## 5. Evidence
Risk assessment; security review; residency review; CRO approval; landing zone IaC; CSPM configuration; exit plan; REG-CL entry. Retained per [STD-TP-01 Section 3.3](../03-standards/STD-TP-01-tpsp-due-diligence-standard.md).
