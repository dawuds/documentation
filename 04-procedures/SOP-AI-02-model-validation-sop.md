...
## 1. Purpose
Operationalise model validation per risk class per [STD-AI-02 §3.2](../03-standards/STD-AI-02-ai-model-validation-standard.md).

## 2. Trigger
- New model pre-deployment
- Re-validation cycle (per [STD-AI-02 §3.6](../03-standards/STD-AI-02-ai-model-validation-standard.md))
...
| 7 | Validator | Test security — adversarial inputs; for LLM: prompt injection per [STD-AI-03 §3.2](../03-standards/STD-AI-03-genai-security-standard.md) |
...
Per [STD-AI-02 §3.2](../03-standards/STD-AI-02-ai-model-validation-standard.md): accuracy + compliance + security tested; Data Science Lead sign-off (not independent validator); validation report retained.
