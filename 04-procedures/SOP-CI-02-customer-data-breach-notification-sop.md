...
| **Parent policy** | [POL-CI-01 §4.5](../02-policies/POL-CI-01-customer-data-protection-policy.md); [POL-13](../02-policies/POL-13-incident-management-policy.md) | **Parent framework** | [CIMF](../01-frameworks/CIMF.md); [CRMF](../01-frameworks/CRMF.md) |
...
| 3 | CCO | Determine BNM notification threshold per [STD-IR-01 §3.5](../03-standards/STD-IR-01-incident-classification-and-severity-standard.md) and Operational Risk Reporting Part C | BNM threshold decision | ≤ 4 hours |
...
|---|---|---|---|---|---|
| 5 | CCO | If BNM material — submit BNM notification | Per BNM channel | BNM notification submitted | Within 4 hours of detection (source-chain caveat per [POL-13 §4.4.3](../02-policies/POL-13-incident-management-policy.md)) |
...
| 14 | DPO | Lessons feed into PIR per [POL-13 §4.7](../02-policies/POL-13-incident-management-policy.md) | PIR document |
