...
| **Implements policy** | [POL-06 Access Control Policy](../02-policies/POL-06-access-control-policy.md) |
...
| **Parent framework(s)** | [CRMF](../01-frameworks/CRMF.md); parent policy [POL-06](../02-policies/POL-06-access-control-policy.md) |
| **COBIT objective(s)** | APO13; DSS05 |

---

## 1. Purpose

This standard operationalises the authentication requirements in [POL-06 Access Control Policy](../02-policies/POL-06-access-control-policy.md). It specifies the **measurable, mandatory** requirements for passwords, multi-factor authentication, session controls, account lifecycle thresholds, and authentication of non-human identities. It is the single source of truth for "how strong must our authentication be?" across GIBB.

## 2. Scope

All authentication to GIBB information systems, applications, and services, including:
...
| 3.4.3 | Customer-facing sessions handling financial transactions **shall** comply with the Digital Banking Authentication Standard (separate document under POL-17). | n/a in this standard. |
...
| 3.7.2 | Any use of a break-glass credential **shall** automatically generate a **SEV-2 incident** triggering review per [SOP-IR-01 Incident Triage SOP](../04-procedures/SOP-IR-01-incident-triage-sop.md). | SIEM use case; Incident Register entries. |
...
- **Implementing procedures:** [SOP-AC-01 Joiner / Mover / Leaver SOP](../04-procedures/SOP-AC-01-joiner-mover-leaver-sop.md)
