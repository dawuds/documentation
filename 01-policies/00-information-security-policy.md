...
| **BNM RMiT** | §6.6 (Board oversight); §8 (Technology Risk Management Framework); §10 (Cybersecurity Management) |
...
- **6.1.1** Information security shall be governed by the Board through the Risk Management Committee. *(Implements ISO/IEC 27001:2022 Clause 5.1; BNM RMiT §6.6.)*
...
- **6.3.1** Access to information assets shall be granted on a least-privilege, role-based basis, and reviewed at intervals defined by [POL-02 Access Control Policy](02-access-control-policy.md). *(Implements ISO/IEC 27002:2022 controls 5.15, 5.18; BNM RMiT Appendix 6.)*
...
- **6.5.1** Information security requirements shall be defined, designed, and tested across the lifecycle of every system, application, and service. *(Implements ISO/IEC 27002:2022 controls 8.25–8.31; BNM RMiT Appendix 8.)*
- **6.5.2** Vulnerabilities shall be identified, prioritised, and remediated within timelines defined by [POL-13 Vulnerability Management Policy](13-vulnerability-management-policy.md). *(Implements ISO/IEC 27002:2022 control 8.8; BNM RMiT Appendix 7.)*

### 6.6 Resilience

- **6.6.1** Critical business services shall have documented recovery objectives (RTO, RPO, MTPD), tested at least annually. *(Implements ISO/IEC 27002:2022 controls 5.29, 5.30; BNM RMiT Appendix 3.)*
- **6.6.2** Incidents shall be detected, classified, contained, and learned from, with material technology incidents escalated to the regulator in accordance with [POL-08 Incident Management Policy](08-incident-management-policy.md). *(Implements ISO/IEC 27002:2022 controls 5.24–5.28; BNM RMiT §10.36–10.43.)*
...
- **6.9.2** Security awareness shall be continuous, not annual-only, and reinforced through targeted training for high-risk roles. *(Implements ISO/IEC 27002:2022 control 6.3; BNM RMiT §12.)*
...
| ID | Policy | Primary ISO/IEC 27002:2022 controls | Primary BNM RMiT |
|---|---|---|---|
| [POL-01](01-acceptable-use-policy.md) | Acceptable Use Policy | 5.10, 8.1 | App. 6 |
| [POL-02](02-access-control-policy.md) | Access Control Policy | 5.15–5.18, 8.2–8.5 | App. 6 |
| [POL-03](03-asset-management-policy.md) | Asset Management Policy | 5.9–5.11 | §9 |
| [POL-04](04-data-classification-policy.md) | Data Classification & Handling Policy | 5.12, 5.13 | App. 9 |
| [POL-05](05-cryptography-policy.md) | Cryptography Policy | 8.24 | §10 |
| [POL-06](06-hr-security-policy.md) | HR Security Policy | 6.1–6.6 | §12 |
| [POL-07](07-supplier-security-policy.md) | Supplier & Third-Party Security Policy | 5.19–5.23 | §13, App. 5 |
| [POL-08](08-incident-management-policy.md) | Incident Management Policy | 5.24–5.28 | §10.36–10.43 |
| [POL-09](09-business-continuity-policy.md) | Business Continuity Policy | 5.29, 5.30 | App. 3 |
| [POL-10](10-physical-security-policy.md) | Physical & Environmental Security Policy | 7.1–7.14 | App. 3 |
| [POL-11](11-operations-security-policy.md) | Operations Security Policy | 8.6, 8.7, 8.13, 8.15, 8.16, 8.32 | §9 |
| [POL-12](12-secure-development-policy.md) | Secure Development Policy | 8.25–8.31 | App. 8 |
| [POL-13](13-vulnerability-management-policy.md) | Vulnerability & Patch Management Policy | 8.8 | App. 7 |
| [POL-14](14-compliance-policy.md) | Compliance Policy | 5.31–5.36 | §11 |
...
- Bank Negara Malaysia *Cyber Risk Management* and related circulars
