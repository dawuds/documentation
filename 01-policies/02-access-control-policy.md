...
- **4.1.3** Identity provisioning and de-provisioning shall be executed through the [Joiner / Mover / Leaver SOP](../03-procedures/joiner-mover-leaver-sop.md). On termination, all access shall be disabled within the timelines defined in [STD-02-01](../02-standards/password-and-authentication-standard.md). *(Implements ISO/IEC 27002:2022 control 5.16; BNM RMiT Section 10.53 (Access Control Policy); Section 10.56 (User Access Matrix).)*
