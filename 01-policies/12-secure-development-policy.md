...
| **BNM RMiT** | Appendix 8 (Security of Digital Services) |
...
- **3.2.1** Security requirements shall be defined for every application, derived from data classification, threat modelling, and applicable regulatory requirements. *(Implements ISO/IEC 27002:2022 control 8.26; BNM RMiT App. 8.)*
...
ISO/IEC 27002:2022 — controls 8.25–8.31. OWASP ASVS (Application Security Verification Standard). NIST SP 800-218 (Secure Software Development Framework). BNM RMiT Appendix 8.
