...
| REG-RR | [Risk Register](risk-register.md) | CRO (CISO for InfoSec subset) | Continuous | ISO/IEC 27001:2022 Cl. 6.1.2 / 6.1.3; BNM RMiT Section 9 (TRMF) |
| REG-PAR | [Privileged Access Review Register](privileged-access-review-register.md) | Head of IAM | Quarterly review | ISO/IEC 27002:2022 control 5.18; BNM RMiT Section 10.53–10.57 |
| REG-INC | [Incident Register](incident-register.md) | CISO | Continuous | ISO/IEC 27002:2022 controls 5.25–5.27; BNM RMiT Section 11.12–11.20 |
