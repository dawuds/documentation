...
To establish requirements for the use of cryptography to protect the confidentiality, integrity, and authenticity of General Bank information.

## 2. Scope

All use of cryptography across General Bank — encryption at rest and in transit, digital signatures, hashing, key management, and supporting infrastructure (PKI, HSMs, KMS).
...
Per [POL-00](00-information-security-policy.md). Use of any non-approved cryptographic algorithm requires written CISO approval.
...
[POL-00](00-information-security-policy.md), [POL-04](04-data-classification-policy.md), [POL-12](12-secure-development-policy.md).
